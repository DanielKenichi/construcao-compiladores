...
type T5AlgumaParser struct {
	*antlr.BaseParser
}

var T5AlgumaParserStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	LiteralNames           []string
...
func t5algumaParserInit() {
	staticData := &T5AlgumaParserStaticData
...
// T5AlgumaParserInit initializes any static state used to implement T5AlgumaParser. By default the
// static state used to implement the parser is lazily initialized during the first call to
// NewT5AlgumaParser(). You can call this function if you wish to initialize the static state ahead
// of time.
func T5AlgumaParserInit() {
	staticData := &T5AlgumaParserStaticData
	staticData.once.Do(t5algumaParserInit)
}

// NewT5AlgumaParser produces a new parser instance for the optional input antlr.TokenStream.
func NewT5AlgumaParser(input antlr.TokenStream) *T5AlgumaParser {
	T5AlgumaParserInit()
	this := new(T5AlgumaParser)
	...
	this.GrammarFileName = "T5Alguma.g4"

	return this
}

// T5AlgumaParser tokens.
const (
	T5AlgumaParserEOF                    = antlr.TokenEOF
	T5AlgumaParserCOMENTARIO             = 1
	T5AlgumaParserALGORITMO              = 2
	T5AlgumaParserDECLARE                = 3
	T5AlgumaParserVAR                    = 4
	T5AlgumaParserCONSTANTE              = 5
	T5AlgumaParserLITERAL                = 6
	T5AlgumaParserINTEIRO                = 7
	T5AlgumaParserREAL                   = 8
	T5AlgumaParserLOGICO                 = 9
	T5AlgumaParserVERDADEIRO             = 10
	T5AlgumaParserFALSO                  = 11
	T5AlgumaParserE                      = 12
	T5AlgumaParserOU                     = 13
	T5AlgumaParserNAO                    = 14
	T5AlgumaParserSE                     = 15
	T5AlgumaParserFIM_SE                 = 16
	T5AlgumaParserENTAO                  = 17
	T5AlgumaParserSENAO                  = 18
	T5AlgumaParserCASO                   = 19
	T5AlgumaParserSEJA                   = 20
	T5AlgumaParserFIM_CASO               = 21
	T5AlgumaParserPARA                   = 22
	T5AlgumaParserFIM_PARA               = 23
	T5AlgumaParserATE                    = 24
	T5AlgumaParserFACA                   = 25
	T5AlgumaParserENQUANTO               = 26
	T5AlgumaParserFIM_ENQUANTO           = 27
	T5AlgumaParserTIPO                   = 28
	T5AlgumaParserREGISTRO               = 29
	T5AlgumaParserFIM_REGISTRO           = 30
	T5AlgumaParserPROCEDIMENTO           = 31
	T5AlgumaParserFIM_PROCEDIMENTO       = 32
	T5AlgumaParserFUNCAO                 = 33
	T5AlgumaParserFIM_FUNCAO             = 34
	T5AlgumaParserRETORNE                = 35
	T5AlgumaParserLEIA                   = 36
	T5AlgumaParserESCREVA                = 37
	T5AlgumaParserFIM_ALGORITMO          = 38
	T5AlgumaParserINTERVALO              = 39
	T5AlgumaParserMENOR                  = 40
	T5AlgumaParserMENORIGUAL             = 41
	T5AlgumaParserMAIOR                  = 42
	T5AlgumaParserMAIORIGUAL             = 43
	T5AlgumaParserIGUAL                  = 44
	T5AlgumaParserDIFERENTE              = 45
	T5AlgumaParserDOISPONTOS             = 46
	T5AlgumaParserABREPAR                = 47
	T5AlgumaParserFECHAPAR               = 48
	T5AlgumaParserABRECHAVE              = 49
	T5AlgumaParserFECHACHAVE             = 50
	T5AlgumaParserVIRGULA                = 51
	T5AlgumaParserASPAS                  = 52
	T5AlgumaParserDIVISAO                = 53
	T5AlgumaParserRESTO                  = 54
	T5AlgumaParserSOMA                   = 55
	T5AlgumaParserSUBTRACAO              = 56
	T5AlgumaParserMULTIPLICACAO          = 57
	T5AlgumaParserATRIBUICAO             = 58
	T5AlgumaParserPONTEIRO               = 59
	T5AlgumaParserENDERECO               = 60
	T5AlgumaParserPONTO                  = 61
	T5AlgumaParserNUM_INT                = 62
	T5AlgumaParserNUM_REAL               = 63
	T5AlgumaParserIDENT                  = 64
	T5AlgumaParserCADEIA                 = 65
	T5AlgumaParserERRO_COMENTARIO_ABERTO = 66
	T5AlgumaParserERRO_CADEIA_ABERTA     = 67
	T5AlgumaParserWS                     = 68
	T5AlgumaParserERRO                   = 69
)

// T5AlgumaParser rules.
const (
	T5AlgumaParserRULE_programa              = 0
	T5AlgumaParserRULE_declaracoes           = 1
	T5AlgumaParserRULE_declaracoes_variaveis = 2
	T5AlgumaParserRULE_variavel              = 3
	T5AlgumaParserRULE_identificador         = 4
	T5AlgumaParserRULE_exp_aritmetica        = 5
	T5AlgumaParserRULE_termo                 = 6
	T5AlgumaParserRULE_fator                 = 7
	T5AlgumaParserRULE_op1                   = 8
	T5AlgumaParserRULE_op2                   = 9
	T5AlgumaParserRULE_op3                   = 10
	T5AlgumaParserRULE_parcela               = 11
	T5AlgumaParserRULE_parcela_unario        = 12
	T5AlgumaParserRULE_op_unario             = 13
	T5AlgumaParserRULE_parcela_nao_unario    = 14
	T5AlgumaParserRULE_tipo                  = 15
	T5AlgumaParserRULE_tipo_basico           = 16
	T5AlgumaParserRULE_tipo_variavel         = 17
	T5AlgumaParserRULE_valor_constante       = 18
	T5AlgumaParserRULE_registro              = 19
	T5AlgumaParserRULE_parametro             = 20
	T5AlgumaParserRULE_parametros            = 21
	T5AlgumaParserRULE_declaracoes_funcoes   = 22
	T5AlgumaParserRULE_corpo                 = 23
	T5AlgumaParserRULE_cmd                   = 24
	T5AlgumaParserRULE_cmdLeia               = 25
	T5AlgumaParserRULE_cmdEscreva            = 26
	T5AlgumaParserRULE_cmdSe                 = 27
	T5AlgumaParserRULE_cmdCaso               = 28
	T5AlgumaParserRULE_cmdPara               = 29
	T5AlgumaParserRULE_cmdEnquanto           = 30
	T5AlgumaParserRULE_cmdFaca               = 31
	T5AlgumaParserRULE_cmdAtribuicao         = 32
	T5AlgumaParserRULE_cmdChamada            = 33
	T5AlgumaParserRULE_cmdRetorne            = 34
	T5AlgumaParserRULE_selecao               = 35
	T5AlgumaParserRULE_item_selecao          = 36
	T5AlgumaParserRULE_constantes            = 37
	T5AlgumaParserRULE_numero_intervalo      = 38
	T5AlgumaParserRULE_exp_relacional        = 39
	T5AlgumaParserRULE_op_relacional         = 40
	T5AlgumaParserRULE_expressao             = 41
	T5AlgumaParserRULE_termo_logico          = 42
	T5AlgumaParserRULE_fator_logico          = 43
	T5AlgumaParserRULE_parcela_logica        = 44
	T5AlgumaParserRULE_op_logico_1           = 45
	T5AlgumaParserRULE_op_logico_2           = 46
)
...
func NewEmptyProgramaContext() *ProgramaContext {
	...
	p.RuleIndex = T5AlgumaParserRULE_programa
	return p
}
...
func (s *ProgramaContext) ALGORITMO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserALGORITMO, 0)
}
...
func (s *ProgramaContext) FIM_ALGORITMO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserFIM_ALGORITMO, 0)
}
...
func (s *ProgramaContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(T5AlgumaListener); ok {
...
func (p *T5AlgumaParser) Programa() (localctx IProgramaContext) {
	localctx = NewProgramaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 0, T5AlgumaParserRULE_programa)
	...
	{
		p.SetState(95)
		p.Match(T5AlgumaParserALGORITMO)
		if p.HasError() {
	...
	{
		p.SetState(97)
		p.Match(T5AlgumaParserFIM_ALGORITMO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyDeclaracoesContext() *DeclaracoesContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_declaracoes
	return p
}
...
func (p *T5AlgumaParser) Declaracoes() (localctx IDeclaracoesContext) {
	localctx = NewDeclaracoesContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 2, T5AlgumaParserRULE_declaracoes)
	var _la int
	...
	for (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&11005853736) != 0 {
		...
		case T5AlgumaParserDECLARE, T5AlgumaParserCONSTANTE, T5AlgumaParserTIPO:
			{
				p.SetState(99)
				p.Declaracoes_variaveis()
			}

		case T5AlgumaParserPROCEDIMENTO, T5AlgumaParserFUNCAO:
			{
				p.SetState(100)
...
func NewEmptyDeclaracoes_variaveisContext() *Declaracoes_variaveisContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_declaracoes_variaveis
	return p
}
...
func (s *Declaracoes_variaveisContext) DECLARE() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserDECLARE, 0)
}
...
func (s *Declaracoes_variaveisContext) CONSTANTE() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserCONSTANTE, 0)
}

func (s *Declaracoes_variaveisContext) IDENT() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserIDENT, 0)
}

func (s *Declaracoes_variaveisContext) DOISPONTOS() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserDOISPONTOS, 0)
}
...
func (s *Declaracoes_variaveisContext) IGUAL() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserIGUAL, 0)
}
...
func (s *Declaracoes_variaveisContext) TIPO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserTIPO, 0)
}
...
func (p *T5AlgumaParser) Declaracoes_variaveis() (localctx IDeclaracoes_variaveisContext) {
	localctx = NewDeclaracoes_variaveisContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 4, T5AlgumaParserRULE_declaracoes_variaveis)
	p.SetState(119)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
		goto errorExit
	...
	switch p.GetTokenStream().LA(1) {
	case T5AlgumaParserDECLARE:
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(106)
			p.Match(T5AlgumaParserDECLARE)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
	...
	case T5AlgumaParserCONSTANTE:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(108)
			p.Match(T5AlgumaParserCONSTANTE)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
		...
		{
			p.SetState(110)
			p.Match(T5AlgumaParserDOISPONTOS)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
	...
	case T5AlgumaParserTIPO:
		p.EnterOuterAlt(localctx, 3)
		{
			p.SetState(115)
			p.Match(T5AlgumaParserTIPO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyVariavelContext() *VariavelContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_variavel
	return p
}
...
func (s *VariavelContext) AllVIRGULA() []antlr.TerminalNode {
	return s.GetTokens(T5AlgumaParserVIRGULA)
}

func (s *VariavelContext) VIRGULA(i int) antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserVIRGULA, i)
}
...
func (p *T5AlgumaParser) Variavel() (localctx IVariavelContext) {
	localctx = NewVariavelContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 6, T5AlgumaParserRULE_variavel)
	var _la int
	...
	for _la == T5AlgumaParserVIRGULA {
		{
			p.SetState(122)
			p.Match(T5AlgumaParserVIRGULA)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyIdentificadorContext() *IdentificadorContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_identificador
	return p
}
...
func (s *IdentificadorContext) AllFECHACHAVE() []antlr.TerminalNode {
	return s.GetTokens(T5AlgumaParserFECHACHAVE)
}

func (s *IdentificadorContext) FECHACHAVE(i int) antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserFECHACHAVE, i)
}
...
func (p *T5AlgumaParser) Identificador() (localctx IIdentificadorContext) {
	localctx = NewIdentificadorContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 8, T5AlgumaParserRULE_identificador)
	var _la int
	...
	for _la == T5AlgumaParserPONTO {
		{
			p.SetState(133)
			p.Match(T5AlgumaParserPONTO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
	...
	for _la == T5AlgumaParserABRECHAVE {
		{
			p.SetState(140)
			p.Match(T5AlgumaParserABRECHAVE)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
		...
		{
			p.SetState(142)
			p.Match(T5AlgumaParserFECHACHAVE)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyExp_aritmeticaContext() *Exp_aritmeticaContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_exp_aritmetica
	return p
}
...
func (p *T5AlgumaParser) Exp_aritmetica() (localctx IExp_aritmeticaContext) {
	localctx = NewExp_aritmeticaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 10, T5AlgumaParserRULE_exp_aritmetica)
	var _alt int
...
func NewEmptyTermoContext() *TermoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_termo
	return p
}
...
func (p *T5AlgumaParser) Termo() (localctx ITermoContext) {
	localctx = NewTermoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 12, T5AlgumaParserRULE_termo)
	var _la int
	...
	for _la == T5AlgumaParserDIVISAO || _la == T5AlgumaParserMULTIPLICACAO {
		{
			p.SetState(159)
			p.Op2()
		}
...
func NewEmptyFatorContext() *FatorContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_fator
	return p
}
...
func (p *T5AlgumaParser) Fator() (localctx IFatorContext) {
	localctx = NewFatorContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 14, T5AlgumaParserRULE_fator)
	var _la int
...
func NewEmptyOp1Context() *Op1Context {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_op1
	return p
}
...
func (s *Op1Context) SOMA() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserSOMA, 0)
}

func (s *Op1Context) SUBTRACAO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserSUBTRACAO, 0)
}
...
func (p *T5AlgumaParser) Op1() (localctx IOp1Context) {
	localctx = NewOp1Context(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 16, T5AlgumaParserRULE_op1)
	var _la int
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !(_la == T5AlgumaParserSOMA || _la == T5AlgumaParserSUBTRACAO) {
...
func NewEmptyOp2Context() *Op2Context {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_op2
	return p
}
...
func (s *Op2Context) MULTIPLICACAO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserMULTIPLICACAO, 0)
}

func (s *Op2Context) DIVISAO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserDIVISAO, 0)
}
...
func (p *T5AlgumaParser) Op2() (localctx IOp2Context) {
	localctx = NewOp2Context(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 18, T5AlgumaParserRULE_op2)
	var _la int
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !(_la == T5AlgumaParserDIVISAO || _la == T5AlgumaParserMULTIPLICACAO) {
			p.GetErrorHandler().RecoverInline(p)
		} else {
			p.GetErrorHandler().ReportMatch(p)
			p.Consume()
...
func NewEmptyOp3Context() *Op3Context {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_op3
	return p
}
...
func (s *Op3Context) RESTO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserRESTO, 0)
}
...
func (p *T5AlgumaParser) Op3() (localctx IOp3Context) {
	localctx = NewOp3Context(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 20, T5AlgumaParserRULE_op3)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(180)
		p.Match(T5AlgumaParserRESTO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyParcelaContext() *ParcelaContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_parcela
	return p
}
...
func (p *T5AlgumaParser) Parcela() (localctx IParcelaContext) {
	localctx = NewParcelaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 22, T5AlgumaParserRULE_parcela)
	var _la int
	...
	switch p.GetTokenStream().LA(1) {
	case T5AlgumaParserABREPAR, T5AlgumaParserSUBTRACAO, T5AlgumaParserPONTEIRO, T5AlgumaParserNUM_INT, T5AlgumaParserNUM_REAL, T5AlgumaParserIDENT:
		p.EnterOuterAlt(localctx, 1)
		p.SetState(183)
		p.GetErrorHandler().Sync(p)
		if p.HasError() {
		...
		if _la == T5AlgumaParserSUBTRACAO {
			{
				p.SetState(182)
				p.Op_unario()
			}
	...
	case T5AlgumaParserENDERECO, T5AlgumaParserCADEIA:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(186)
...
func NewEmptyParcela_unarioContext() *Parcela_unarioContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_parcela_unario
	return p
}
...
func (s *Parcela_unarioContext) PONTEIRO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserPONTEIRO, 0)
}
...
func (s *Parcela_unarioContext) ABREPAR() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserABREPAR, 0)
}
...
func (s *Parcela_unarioContext) FECHAPAR() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserFECHAPAR, 0)
}
...
func (s *Parcela_unarioContext) NUM_INT() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserNUM_INT, 0)
}

func (s *Parcela_unarioContext) NUM_REAL() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserNUM_REAL, 0)
}
...
func (p *T5AlgumaParser) Parcela_unario() (localctx IParcela_unarioContext) {
	localctx = NewParcela_unarioContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 24, T5AlgumaParserRULE_parcela_unario)
	var _la int
	...
	case 1:
		...
		if _la == T5AlgumaParserPONTEIRO {
			{
				p.SetState(189)
				p.Match(T5AlgumaParserPONTEIRO)
				if p.HasError() {
					// Recognition error - abort rule
					goto errorExit
				}
	...
	case 2:
		...
		{
			p.SetState(203)
			p.Match(T5AlgumaParserFECHAPAR)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
	...
	case 4:
		...
		{
			p.SetState(206)
			p.Match(T5AlgumaParserNUM_REAL)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyOp_unarioContext() *Op_unarioContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_op_unario
	return p
}
...
func (p *T5AlgumaParser) Op_unario() (localctx IOp_unarioContext) {
	localctx = NewOp_unarioContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 26, T5AlgumaParserRULE_op_unario)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(213)
		p.Match(T5AlgumaParserSUBTRACAO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyParcela_nao_unarioContext() *Parcela_nao_unarioContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_parcela_nao_unario
	return p
}
...
func (s *Parcela_nao_unarioContext) ENDERECO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserENDERECO, 0)
}
...
func (s *Parcela_nao_unarioContext) CADEIA() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserCADEIA, 0)
}
...
func (p *T5AlgumaParser) Parcela_nao_unario() (localctx IParcela_nao_unarioContext) {
	localctx = NewParcela_nao_unarioContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 28, T5AlgumaParserRULE_parcela_nao_unario)
	p.SetState(218)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
		goto errorExit
	...
	switch p.GetTokenStream().LA(1) {
	case T5AlgumaParserENDERECO:
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(215)
			p.Match(T5AlgumaParserENDERECO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
	...
	case T5AlgumaParserCADEIA:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(217)
			p.Match(T5AlgumaParserCADEIA)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyTipoContext() *TipoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_tipo
	return p
}
...
func (p *T5AlgumaParser) Tipo() (localctx ITipoContext) {
	localctx = NewTipoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 30, T5AlgumaParserRULE_tipo)
	p.SetState(222)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
		goto errorExit
	...
	case T5AlgumaParserLITERAL, T5AlgumaParserINTEIRO, T5AlgumaParserREAL, T5AlgumaParserLOGICO, T5AlgumaParserPONTEIRO, T5AlgumaParserIDENT:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(221)
			p.Tipo_variavel()
...
func NewEmptyTipo_basicoContext() *Tipo_basicoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_tipo_basico
	return p
}
...
func (s *Tipo_basicoContext) LITERAL() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserLITERAL, 0)
}

func (s *Tipo_basicoContext) INTEIRO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserINTEIRO, 0)
}

func (s *Tipo_basicoContext) REAL() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserREAL, 0)
}

func (s *Tipo_basicoContext) LOGICO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserLOGICO, 0)
}
...
func (p *T5AlgumaParser) Tipo_basico() (localctx ITipo_basicoContext) {
	localctx = NewTipo_basicoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 32, T5AlgumaParserRULE_tipo_basico)
	var _la int
...
func NewEmptyTipo_variavelContext() *Tipo_variavelContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_tipo_variavel
	return p
}
...
func (p *T5AlgumaParser) Tipo_variavel() (localctx ITipo_variavelContext) {
	localctx = NewTipo_variavelContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 34, T5AlgumaParserRULE_tipo_variavel)
	var _la int
	...
	switch p.GetTokenStream().LA(1) {
	case T5AlgumaParserLITERAL, T5AlgumaParserINTEIRO, T5AlgumaParserREAL, T5AlgumaParserLOGICO:
		{
			p.SetState(229)
			p.Tipo_basico()
		}

	case T5AlgumaParserIDENT:
		{
			p.SetState(230)
			p.Match(T5AlgumaParserIDENT)
			if p.HasError() {
...
func NewEmptyValor_constanteContext() *Valor_constanteContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_valor_constante
	return p
}
...
func (s *Valor_constanteContext) VERDADEIRO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserVERDADEIRO, 0)
}

func (s *Valor_constanteContext) FALSO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserFALSO, 0)
}
...
func (p *T5AlgumaParser) Valor_constante() (localctx IValor_constanteContext) {
	localctx = NewValor_constanteContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 36, T5AlgumaParserRULE_valor_constante)
	var _la int
...
func NewEmptyRegistroContext() *RegistroContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_registro
	return p
}
...
func (s *RegistroContext) REGISTRO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserREGISTRO, 0)
}

func (s *RegistroContext) FIM_REGISTRO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserFIM_REGISTRO, 0)
}
...
func (p *T5AlgumaParser) Registro() (localctx IRegistroContext) {
	localctx = NewRegistroContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 38, T5AlgumaParserRULE_registro)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(235)
		p.Match(T5AlgumaParserREGISTRO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
	...
	{
		p.SetState(242)
		p.Match(T5AlgumaParserFIM_REGISTRO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyParametroContext() *ParametroContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_parametro
	return p
}
...
func (s *ParametroContext) VAR() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserVAR, 0)
}
...
func (p *T5AlgumaParser) Parametro() (localctx IParametroContext) {
	localctx = NewParametroContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 40, T5AlgumaParserRULE_parametro)
	var _la int
	...
	if _la == T5AlgumaParserVAR {
		{
			p.SetState(244)
			p.Match(T5AlgumaParserVAR)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyParametrosContext() *ParametrosContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_parametros
	return p
}
...
func (p *T5AlgumaParser) Parametros() (localctx IParametrosContext) {
	localctx = NewParametrosContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 42, T5AlgumaParserRULE_parametros)
	var _la int
...
func NewEmptyDeclaracoes_funcoesContext() *Declaracoes_funcoesContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_declaracoes_funcoes
	return p
}
...
func (s *Declaracoes_funcoesContext) PROCEDIMENTO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserPROCEDIMENTO, 0)
}
...
func (s *Declaracoes_funcoesContext) FIM_PROCEDIMENTO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserFIM_PROCEDIMENTO, 0)
}
...
func (s *Declaracoes_funcoesContext) FUNCAO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserFUNCAO, 0)
}
...
func (s *Declaracoes_funcoesContext) FIM_FUNCAO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserFIM_FUNCAO, 0)
}
...
func (p *T5AlgumaParser) Declaracoes_funcoes() (localctx IDeclaracoes_funcoesContext) {
	localctx = NewDeclaracoes_funcoesContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 44, T5AlgumaParserRULE_declaracoes_funcoes)
	var _la int
	...
	switch p.GetTokenStream().LA(1) {
	case T5AlgumaParserPROCEDIMENTO:
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(266)
			p.Match(T5AlgumaParserPROCEDIMENTO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
		...
		if _la == T5AlgumaParserVAR || _la == T5AlgumaParserIDENT {
			{
				p.SetState(269)
				p.Parametros()
			}
		...
		{
			p.SetState(285)
			p.Match(T5AlgumaParserFIM_PROCEDIMENTO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
	...
	case T5AlgumaParserFUNCAO:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(286)
			p.Match(T5AlgumaParserFUNCAO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
		...
		{
			p.SetState(307)
			p.Match(T5AlgumaParserFIM_FUNCAO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyCorpoContext() *CorpoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_corpo
	return p
}
...
func (p *T5AlgumaParser) Corpo() (localctx ICorpoContext) {
	localctx = NewCorpoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 46, T5AlgumaParserRULE_corpo)
	var _la int
...
func NewEmptyCmdContext() *CmdContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_cmd
	return p
}
...
func (p *T5AlgumaParser) Cmd() (localctx ICmdContext) {
	localctx = NewCmdContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 48, T5AlgumaParserRULE_cmd)
	p.SetState(333)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
		goto errorExit
...
func NewEmptyCmdLeiaContext() *CmdLeiaContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_cmdLeia
	return p
}
...
func (s *CmdLeiaContext) LEIA() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserLEIA, 0)
}
...
func (s *CmdLeiaContext) AllPONTEIRO() []antlr.TerminalNode {
	return s.GetTokens(T5AlgumaParserPONTEIRO)
}

func (s *CmdLeiaContext) PONTEIRO(i int) antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserPONTEIRO, i)
}
...
func (p *T5AlgumaParser) CmdLeia() (localctx ICmdLeiaContext) {
	localctx = NewCmdLeiaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 50, T5AlgumaParserRULE_cmdLeia)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(335)
		p.Match(T5AlgumaParserLEIA)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyCmdEscrevaContext() *CmdEscrevaContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_cmdEscreva
	return p
}
...
func (s *CmdEscrevaContext) ESCREVA() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserESCREVA, 0)
}
...
func (p *T5AlgumaParser) CmdEscreva() (localctx ICmdEscrevaContext) {
	localctx = NewCmdEscrevaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 52, T5AlgumaParserRULE_cmdEscreva)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(353)
		p.Match(T5AlgumaParserESCREVA)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyCmdSeContext() *CmdSeContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_cmdSe
	return p
}
...
func (s *CmdSeContext) SE() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserSE, 0)
}
...
func (s *CmdSeContext) ENTAO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserENTAO, 0)
}

func (s *CmdSeContext) FIM_SE() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserFIM_SE, 0)
}

func (s *CmdSeContext) SENAO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserSENAO, 0)
}
...
func (p *T5AlgumaParser) CmdSe() (localctx ICmdSeContext) {
	localctx = NewCmdSeContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 54, T5AlgumaParserRULE_cmdSe)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(365)
		p.Match(T5AlgumaParserSE)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
	...
	if _la == T5AlgumaParserSENAO {
		{
			p.SetState(374)
			p.Match(T5AlgumaParserSENAO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyCmdCasoContext() *CmdCasoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_cmdCaso
	return p
}
...
func (s *CmdCasoContext) CASO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserCASO, 0)
}
...
func (s *CmdCasoContext) SEJA() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserSEJA, 0)
}
...
func (s *CmdCasoContext) FIM_CASO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserFIM_CASO, 0)
}
...
func (p *T5AlgumaParser) CmdCaso() (localctx ICmdCasoContext) {
	localctx = NewCmdCasoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 56, T5AlgumaParserRULE_cmdCaso)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(385)
		p.Match(T5AlgumaParserCASO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
	...
	{
		p.SetState(398)
		p.Match(T5AlgumaParserFIM_CASO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyCmdParaContext() *CmdParaContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_cmdPara
	return p
}
...
func (s *CmdParaContext) PARA() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserPARA, 0)
}
...
func (s *CmdParaContext) ATRIBUICAO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserATRIBUICAO, 0)
}

func (s *CmdParaContext) ATE() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserATE, 0)
}

func (s *CmdParaContext) FACA() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserFACA, 0)
}

func (s *CmdParaContext) FIM_PARA() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserFIM_PARA, 0)
}
...
func (p *T5AlgumaParser) CmdPara() (localctx ICmdParaContext) {
	localctx = NewCmdParaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 58, T5AlgumaParserRULE_cmdPara)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(400)
		p.Match(T5AlgumaParserPARA)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
	...
	{
		p.SetState(402)
		p.Match(T5AlgumaParserATRIBUICAO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
	...
	{
		p.SetState(413)
		p.Match(T5AlgumaParserFIM_PARA)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyCmdEnquantoContext() *CmdEnquantoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_cmdEnquanto
	return p
}
...
func (s *CmdEnquantoContext) ENQUANTO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserENQUANTO, 0)
}
...
func (s *CmdEnquantoContext) FIM_ENQUANTO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserFIM_ENQUANTO, 0)
}
...
func (p *T5AlgumaParser) CmdEnquanto() (localctx ICmdEnquantoContext) {
	localctx = NewCmdEnquantoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 60, T5AlgumaParserRULE_cmdEnquanto)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(415)
		p.Match(T5AlgumaParserENQUANTO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
	...
	{
		p.SetState(424)
		p.Match(T5AlgumaParserFIM_ENQUANTO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyCmdFacaContext() *CmdFacaContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_cmdFaca
	return p
}
...
func (p *T5AlgumaParser) CmdFaca() (localctx ICmdFacaContext) {
	localctx = NewCmdFacaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 62, T5AlgumaParserRULE_cmdFaca)
	var _la int
...
func NewEmptyCmdAtribuicaoContext() *CmdAtribuicaoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_cmdAtribuicao
	return p
}
...
func (p *T5AlgumaParser) CmdAtribuicao() (localctx ICmdAtribuicaoContext) {
	localctx = NewCmdAtribuicaoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 64, T5AlgumaParserRULE_cmdAtribuicao)
	var _la int
...
func NewEmptyCmdChamadaContext() *CmdChamadaContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_cmdChamada
	return p
}
...
func (p *T5AlgumaParser) CmdChamada() (localctx ICmdChamadaContext) {
	localctx = NewCmdChamadaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 66, T5AlgumaParserRULE_cmdChamada)
	var _la int
...
func NewEmptyCmdRetorneContext() *CmdRetorneContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_cmdRetorne
	return p
}
...
func (s *CmdRetorneContext) RETORNE() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserRETORNE, 0)
}
...
func (p *T5AlgumaParser) CmdRetorne() (localctx ICmdRetorneContext) {
	localctx = NewCmdRetorneContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 68, T5AlgumaParserRULE_cmdRetorne)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(455)
		p.Match(T5AlgumaParserRETORNE)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptySelecaoContext() *SelecaoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_selecao
	return p
}
...
func (p *T5AlgumaParser) Selecao() (localctx ISelecaoContext) {
	localctx = NewSelecaoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 70, T5AlgumaParserRULE_selecao)
	var _la int
	...
	for _la == T5AlgumaParserSUBTRACAO || _la == T5AlgumaParserNUM_INT {
		{
			p.SetState(458)
			p.Item_selecao()
		}
...
func NewEmptyItem_selecaoContext() *Item_selecaoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_item_selecao
	return p
}
...
func (p *T5AlgumaParser) Item_selecao() (localctx IItem_selecaoContext) {
	localctx = NewItem_selecaoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 72, T5AlgumaParserRULE_item_selecao)
	var _la int
...
func NewEmptyConstantesContext() *ConstantesContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_constantes
	return p
}
...
func (p *T5AlgumaParser) Constantes() (localctx IConstantesContext) {
	localctx = NewConstantesContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 74, T5AlgumaParserRULE_constantes)
	var _la int
...
func NewEmptyNumero_intervaloContext() *Numero_intervaloContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_numero_intervalo
	return p
}
...
func (s *Numero_intervaloContext) AllNUM_INT() []antlr.TerminalNode {
	return s.GetTokens(T5AlgumaParserNUM_INT)
}

func (s *Numero_intervaloContext) NUM_INT(i int) antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserNUM_INT, i)
}
...
func (s *Numero_intervaloContext) INTERVALO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserINTERVALO, 0)
}
...
func (p *T5AlgumaParser) Numero_intervalo() (localctx INumero_intervaloContext) {
	localctx = NewNumero_intervaloContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 76, T5AlgumaParserRULE_numero_intervalo)
	var _la int
	...
	if _la == T5AlgumaParserINTERVALO {
		{
			p.SetState(484)
			p.Match(T5AlgumaParserINTERVALO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyExp_relacionalContext() *Exp_relacionalContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_exp_relacional
	return p
}
...
func (p *T5AlgumaParser) Exp_relacional() (localctx IExp_relacionalContext) {
	localctx = NewExp_relacionalContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 78, T5AlgumaParserRULE_exp_relacional)
	var _la int
...
func NewEmptyOp_relacionalContext() *Op_relacionalContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_op_relacional
	return p
}
...
func (p *T5AlgumaParser) Op_relacional() (localctx IOp_relacionalContext) {
	localctx = NewOp_relacionalContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 80, T5AlgumaParserRULE_op_relacional)
	var _la int
...
func NewEmptyExpressaoContext() *ExpressaoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_expressao
	return p
}
...
func (p *T5AlgumaParser) Expressao() (localctx IExpressaoContext) {
	localctx = NewExpressaoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 82, T5AlgumaParserRULE_expressao)
	var _la int
...
func NewEmptyTermo_logicoContext() *Termo_logicoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_termo_logico
	return p
}
...
func (p *T5AlgumaParser) Termo_logico() (localctx ITermo_logicoContext) {
	localctx = NewTermo_logicoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 84, T5AlgumaParserRULE_termo_logico)
	var _la int
...
func NewEmptyFator_logicoContext() *Fator_logicoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_fator_logico
	return p
}
...
func (s *Fator_logicoContext) NAO() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserNAO, 0)
}
...
func (p *T5AlgumaParser) Fator_logico() (localctx IFator_logicoContext) {
	localctx = NewFator_logicoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 86, T5AlgumaParserRULE_fator_logico)
	var _la int
	...
	if _la == T5AlgumaParserNAO {
		{
			p.SetState(517)
			p.Match(T5AlgumaParserNAO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyParcela_logicaContext() *Parcela_logicaContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_parcela_logica
	return p
}
...
func (p *T5AlgumaParser) Parcela_logica() (localctx IParcela_logicaContext) {
	localctx = NewParcela_logicaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 88, T5AlgumaParserRULE_parcela_logica)
	var _la int
	...
	switch p.GetTokenStream().LA(1) {
	case T5AlgumaParserVERDADEIRO, T5AlgumaParserFALSO:
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(522)
			_la = p.GetTokenStream().LA(1)

			if !(_la == T5AlgumaParserVERDADEIRO || _la == T5AlgumaParserFALSO) {
				p.GetErrorHandler().RecoverInline(p)
			} else {
				p.GetErrorHandler().ReportMatch(p)
				p.Consume()
	...
	case T5AlgumaParserABREPAR, T5AlgumaParserSUBTRACAO, T5AlgumaParserPONTEIRO, T5AlgumaParserENDERECO, T5AlgumaParserNUM_INT, T5AlgumaParserNUM_REAL, T5AlgumaParserIDENT, T5AlgumaParserCADEIA:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(523)
			p.Exp_relacional()
...
func NewEmptyOp_logico_1Context() *Op_logico_1Context {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_op_logico_1
	return p
}
...
func (s *Op_logico_1Context) OU() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserOU, 0)
}
...
func (p *T5AlgumaParser) Op_logico_1() (localctx IOp_logico_1Context) {
	localctx = NewOp_logico_1Context(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 90, T5AlgumaParserRULE_op_logico_1)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(526)
		p.Match(T5AlgumaParserOU)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyOp_logico_2Context() *Op_logico_2Context {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T5AlgumaParserRULE_op_logico_2
	return p
}
...
func (s *Op_logico_2Context) E() antlr.TerminalNode {
	return s.GetToken(T5AlgumaParserE, 0)
}
...
func (p *T5AlgumaParser) Op_logico_2() (localctx IOp_logico_2Context) {
	localctx = NewOp_logico_2Context(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 92, T5AlgumaParserRULE_op_logico_2)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(528)
		p.Match(T5AlgumaParserE)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
