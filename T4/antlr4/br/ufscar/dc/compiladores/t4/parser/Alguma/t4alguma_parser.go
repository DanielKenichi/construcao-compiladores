...
type T4AlgumaParser struct {
	*antlr.BaseParser
}

var T4AlgumaParserStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	LiteralNames           []string
...
func t4algumaParserInit() {
	staticData := &T4AlgumaParserStaticData
...
// T4AlgumaParserInit initializes any static state used to implement T4AlgumaParser. By default the
// static state used to implement the parser is lazily initialized during the first call to
// NewT4AlgumaParser(). You can call this function if you wish to initialize the static state ahead
// of time.
func T4AlgumaParserInit() {
	staticData := &T4AlgumaParserStaticData
	staticData.once.Do(t4algumaParserInit)
}

// NewT4AlgumaParser produces a new parser instance for the optional input antlr.TokenStream.
func NewT4AlgumaParser(input antlr.TokenStream) *T4AlgumaParser {
	T4AlgumaParserInit()
	this := new(T4AlgumaParser)
	...
	this.GrammarFileName = "T4Alguma.g4"

	return this
}

// T4AlgumaParser tokens.
const (
	T4AlgumaParserEOF                    = antlr.TokenEOF
	T4AlgumaParserCOMENTARIO             = 1
	T4AlgumaParserALGORITMO              = 2
	T4AlgumaParserDECLARE                = 3
	T4AlgumaParserVAR                    = 4
	T4AlgumaParserCONSTANTE              = 5
	T4AlgumaParserLITERAL                = 6
	T4AlgumaParserINTEIRO                = 7
	T4AlgumaParserREAL                   = 8
	T4AlgumaParserLOGICO                 = 9
	T4AlgumaParserVERDADEIRO             = 10
	T4AlgumaParserFALSO                  = 11
	T4AlgumaParserE                      = 12
	T4AlgumaParserOU                     = 13
	T4AlgumaParserNAO                    = 14
	T4AlgumaParserSE                     = 15
	T4AlgumaParserFIM_SE                 = 16
	T4AlgumaParserENTAO                  = 17
	T4AlgumaParserSENAO                  = 18
	T4AlgumaParserCASO                   = 19
	T4AlgumaParserSEJA                   = 20
	T4AlgumaParserFIM_CASO               = 21
	T4AlgumaParserPARA                   = 22
	T4AlgumaParserFIM_PARA               = 23
	T4AlgumaParserATE                    = 24
	T4AlgumaParserFACA                   = 25
	T4AlgumaParserENQUANTO               = 26
	T4AlgumaParserFIM_ENQUANTO           = 27
	T4AlgumaParserTIPO                   = 28
	T4AlgumaParserREGISTRO               = 29
	T4AlgumaParserFIM_REGISTRO           = 30
	T4AlgumaParserPROCEDIMENTO           = 31
	T4AlgumaParserFIM_PROCEDIMENTO       = 32
	T4AlgumaParserFUNCAO                 = 33
	T4AlgumaParserFIM_FUNCAO             = 34
	T4AlgumaParserRETORNE                = 35
	T4AlgumaParserLEIA                   = 36
	T4AlgumaParserESCREVA                = 37
	T4AlgumaParserFIM_ALGORITMO          = 38
	T4AlgumaParserINTERVALO              = 39
	T4AlgumaParserMENOR                  = 40
	T4AlgumaParserMENORIGUAL             = 41
	T4AlgumaParserMAIOR                  = 42
	T4AlgumaParserMAIORIGUAL             = 43
	T4AlgumaParserIGUAL                  = 44
	T4AlgumaParserDIFERENTE              = 45
	T4AlgumaParserDOISPONTOS             = 46
	T4AlgumaParserABREPAR                = 47
	T4AlgumaParserFECHAPAR               = 48
	T4AlgumaParserABRECHAVE              = 49
	T4AlgumaParserFECHACHAVE             = 50
	T4AlgumaParserVIRGULA                = 51
	T4AlgumaParserASPAS                  = 52
	T4AlgumaParserDIVISAO                = 53
	T4AlgumaParserRESTO                  = 54
	T4AlgumaParserSOMA                   = 55
	T4AlgumaParserSUBTRACAO              = 56
	T4AlgumaParserMULTIPLICACAO          = 57
	T4AlgumaParserATRIBUICAO             = 58
	T4AlgumaParserPONTEIRO               = 59
	T4AlgumaParserENDERECO               = 60
	T4AlgumaParserPONTO                  = 61
	T4AlgumaParserNUM_INT                = 62
	T4AlgumaParserNUM_REAL               = 63
	T4AlgumaParserIDENT                  = 64
	T4AlgumaParserCADEIA                 = 65
	T4AlgumaParserERRO_COMENTARIO_ABERTO = 66
	T4AlgumaParserERRO_CADEIA_ABERTA     = 67
	T4AlgumaParserWS                     = 68
	T4AlgumaParserERRO                   = 69
)

// T4AlgumaParser rules.
const (
	T4AlgumaParserRULE_programa              = 0
	T4AlgumaParserRULE_declaracoes           = 1
	T4AlgumaParserRULE_declaracoes_variaveis = 2
	T4AlgumaParserRULE_variavel              = 3
	T4AlgumaParserRULE_identificador         = 4
	T4AlgumaParserRULE_exp_aritmetica        = 5
	T4AlgumaParserRULE_termo                 = 6
	T4AlgumaParserRULE_fator                 = 7
	T4AlgumaParserRULE_op1                   = 8
	T4AlgumaParserRULE_op2                   = 9
	T4AlgumaParserRULE_op3                   = 10
	T4AlgumaParserRULE_parcela               = 11
	T4AlgumaParserRULE_parcela_unario        = 12
	T4AlgumaParserRULE_op_unario             = 13
	T4AlgumaParserRULE_parcela_nao_unario    = 14
	T4AlgumaParserRULE_tipo                  = 15
	T4AlgumaParserRULE_tipo_basico           = 16
	T4AlgumaParserRULE_tipo_variavel         = 17
	T4AlgumaParserRULE_valor_constante       = 18
	T4AlgumaParserRULE_registro              = 19
	T4AlgumaParserRULE_parametro             = 20
	T4AlgumaParserRULE_parametros            = 21
	T4AlgumaParserRULE_declaracoes_funcoes   = 22
	T4AlgumaParserRULE_corpo                 = 23
	T4AlgumaParserRULE_cmd                   = 24
	T4AlgumaParserRULE_cmdLeia               = 25
	T4AlgumaParserRULE_cmdEscreva            = 26
	T4AlgumaParserRULE_cmdSe                 = 27
	T4AlgumaParserRULE_cmdCaso               = 28
	T4AlgumaParserRULE_cmdPara               = 29
	T4AlgumaParserRULE_cmdEnquanto           = 30
	T4AlgumaParserRULE_cmdFaca               = 31
	T4AlgumaParserRULE_cmdAtribuicao         = 32
	T4AlgumaParserRULE_cmdChamada            = 33
	T4AlgumaParserRULE_cmdRetorne            = 34
	T4AlgumaParserRULE_selecao               = 35
	T4AlgumaParserRULE_item_selecao          = 36
	T4AlgumaParserRULE_constantes            = 37
	T4AlgumaParserRULE_numero_intervalo      = 38
	T4AlgumaParserRULE_exp_relacional        = 39
	T4AlgumaParserRULE_op_relacional         = 40
	T4AlgumaParserRULE_expressao             = 41
	T4AlgumaParserRULE_termo_logico          = 42
	T4AlgumaParserRULE_fator_logico          = 43
	T4AlgumaParserRULE_parcela_logica        = 44
	T4AlgumaParserRULE_op_logico_1           = 45
	T4AlgumaParserRULE_op_logico_2           = 46
)
...
func NewEmptyProgramaContext() *ProgramaContext {
	...
	p.RuleIndex = T4AlgumaParserRULE_programa
	return p
}
...
func (s *ProgramaContext) ALGORITMO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserALGORITMO, 0)
}
...
func (s *ProgramaContext) FIM_ALGORITMO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserFIM_ALGORITMO, 0)
}
...
func (s *ProgramaContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(T4AlgumaListener); ok {
...
func (p *T4AlgumaParser) Programa() (localctx IProgramaContext) {
	localctx = NewProgramaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 0, T4AlgumaParserRULE_programa)
	...
	{
		p.SetState(95)
		p.Match(T4AlgumaParserALGORITMO)
		if p.HasError() {
	...
	{
		p.SetState(97)
		p.Match(T4AlgumaParserFIM_ALGORITMO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyDeclaracoesContext() *DeclaracoesContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_declaracoes
	return p
}
...
func (p *T4AlgumaParser) Declaracoes() (localctx IDeclaracoesContext) {
	localctx = NewDeclaracoesContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 2, T4AlgumaParserRULE_declaracoes)
	var _la int
	...
	for (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&11005853736) != 0 {
		...
		case T4AlgumaParserDECLARE, T4AlgumaParserCONSTANTE, T4AlgumaParserTIPO:
			{
				p.SetState(99)
				p.Declaracoes_variaveis()
			}

		case T4AlgumaParserPROCEDIMENTO, T4AlgumaParserFUNCAO:
			{
				p.SetState(100)
...
func NewEmptyDeclaracoes_variaveisContext() *Declaracoes_variaveisContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_declaracoes_variaveis
	return p
}
...
func (s *Declaracoes_variaveisContext) DECLARE() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserDECLARE, 0)
}
...
func (s *Declaracoes_variaveisContext) CONSTANTE() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserCONSTANTE, 0)
}

func (s *Declaracoes_variaveisContext) IDENT() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserIDENT, 0)
}

func (s *Declaracoes_variaveisContext) DOISPONTOS() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserDOISPONTOS, 0)
}
...
func (s *Declaracoes_variaveisContext) IGUAL() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserIGUAL, 0)
}
...
func (s *Declaracoes_variaveisContext) TIPO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserTIPO, 0)
}
...
func (p *T4AlgumaParser) Declaracoes_variaveis() (localctx IDeclaracoes_variaveisContext) {
	localctx = NewDeclaracoes_variaveisContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 4, T4AlgumaParserRULE_declaracoes_variaveis)
	p.SetState(119)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
		goto errorExit
	...
	switch p.GetTokenStream().LA(1) {
	case T4AlgumaParserDECLARE:
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(106)
			p.Match(T4AlgumaParserDECLARE)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
	...
	case T4AlgumaParserCONSTANTE:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(108)
			p.Match(T4AlgumaParserCONSTANTE)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
		...
		{
			p.SetState(110)
			p.Match(T4AlgumaParserDOISPONTOS)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
	...
	case T4AlgumaParserTIPO:
		p.EnterOuterAlt(localctx, 3)
		{
			p.SetState(115)
			p.Match(T4AlgumaParserTIPO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyVariavelContext() *VariavelContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_variavel
	return p
}
...
func (s *VariavelContext) AllVIRGULA() []antlr.TerminalNode {
	return s.GetTokens(T4AlgumaParserVIRGULA)
}

func (s *VariavelContext) VIRGULA(i int) antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserVIRGULA, i)
}
...
func (p *T4AlgumaParser) Variavel() (localctx IVariavelContext) {
	localctx = NewVariavelContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 6, T4AlgumaParserRULE_variavel)
	var _la int
	...
	for _la == T4AlgumaParserVIRGULA {
		{
			p.SetState(122)
			p.Match(T4AlgumaParserVIRGULA)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyIdentificadorContext() *IdentificadorContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_identificador
	return p
}
...
func (s *IdentificadorContext) AllFECHACHAVE() []antlr.TerminalNode {
	return s.GetTokens(T4AlgumaParserFECHACHAVE)
}

func (s *IdentificadorContext) FECHACHAVE(i int) antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserFECHACHAVE, i)
}
...
func (p *T4AlgumaParser) Identificador() (localctx IIdentificadorContext) {
	localctx = NewIdentificadorContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 8, T4AlgumaParserRULE_identificador)
	var _la int
	...
	for _la == T4AlgumaParserPONTO {
		{
			p.SetState(133)
			p.Match(T4AlgumaParserPONTO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
	...
	for _la == T4AlgumaParserABRECHAVE {
		{
			p.SetState(140)
			p.Match(T4AlgumaParserABRECHAVE)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
		...
		{
			p.SetState(142)
			p.Match(T4AlgumaParserFECHACHAVE)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyExp_aritmeticaContext() *Exp_aritmeticaContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_exp_aritmetica
	return p
}
...
func (p *T4AlgumaParser) Exp_aritmetica() (localctx IExp_aritmeticaContext) {
	localctx = NewExp_aritmeticaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 10, T4AlgumaParserRULE_exp_aritmetica)
	var _alt int
...
func NewEmptyTermoContext() *TermoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_termo
	return p
}
...
func (p *T4AlgumaParser) Termo() (localctx ITermoContext) {
	localctx = NewTermoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 12, T4AlgumaParserRULE_termo)
	var _la int
	...
	for _la == T4AlgumaParserDIVISAO || _la == T4AlgumaParserMULTIPLICACAO {
		{
			p.SetState(159)
			p.Op2()
		}
...
func NewEmptyFatorContext() *FatorContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_fator
	return p
}
...
func (p *T4AlgumaParser) Fator() (localctx IFatorContext) {
	localctx = NewFatorContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 14, T4AlgumaParserRULE_fator)
	var _la int
...
func NewEmptyOp1Context() *Op1Context {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_op1
	return p
}
...
func (s *Op1Context) SOMA() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserSOMA, 0)
}

func (s *Op1Context) SUBTRACAO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserSUBTRACAO, 0)
}
...
func (p *T4AlgumaParser) Op1() (localctx IOp1Context) {
	localctx = NewOp1Context(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 16, T4AlgumaParserRULE_op1)
	var _la int
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !(_la == T4AlgumaParserSOMA || _la == T4AlgumaParserSUBTRACAO) {
...
func NewEmptyOp2Context() *Op2Context {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_op2
	return p
}
...
func (s *Op2Context) MULTIPLICACAO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserMULTIPLICACAO, 0)
}

func (s *Op2Context) DIVISAO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserDIVISAO, 0)
}
...
func (p *T4AlgumaParser) Op2() (localctx IOp2Context) {
	localctx = NewOp2Context(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 18, T4AlgumaParserRULE_op2)
	var _la int
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !(_la == T4AlgumaParserDIVISAO || _la == T4AlgumaParserMULTIPLICACAO) {
			p.GetErrorHandler().RecoverInline(p)
		} else {
			p.GetErrorHandler().ReportMatch(p)
			p.Consume()
...
func NewEmptyOp3Context() *Op3Context {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_op3
	return p
}
...
func (s *Op3Context) RESTO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserRESTO, 0)
}
...
func (p *T4AlgumaParser) Op3() (localctx IOp3Context) {
	localctx = NewOp3Context(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 20, T4AlgumaParserRULE_op3)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(180)
		p.Match(T4AlgumaParserRESTO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyParcelaContext() *ParcelaContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_parcela
	return p
}
...
func (p *T4AlgumaParser) Parcela() (localctx IParcelaContext) {
	localctx = NewParcelaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 22, T4AlgumaParserRULE_parcela)
	var _la int
	...
	switch p.GetTokenStream().LA(1) {
	case T4AlgumaParserABREPAR, T4AlgumaParserSUBTRACAO, T4AlgumaParserPONTEIRO, T4AlgumaParserNUM_INT, T4AlgumaParserNUM_REAL, T4AlgumaParserIDENT:
		p.EnterOuterAlt(localctx, 1)
		p.SetState(183)
		p.GetErrorHandler().Sync(p)
		if p.HasError() {
		...
		if _la == T4AlgumaParserSUBTRACAO {
			{
				p.SetState(182)
				p.Op_unario()
			}
	...
	case T4AlgumaParserENDERECO, T4AlgumaParserCADEIA:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(186)
...
func NewEmptyParcela_unarioContext() *Parcela_unarioContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_parcela_unario
	return p
}
...
func (s *Parcela_unarioContext) PONTEIRO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserPONTEIRO, 0)
}
...
func (s *Parcela_unarioContext) ABREPAR() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserABREPAR, 0)
}
...
func (s *Parcela_unarioContext) FECHAPAR() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserFECHAPAR, 0)
}
...
func (s *Parcela_unarioContext) NUM_INT() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserNUM_INT, 0)
}

func (s *Parcela_unarioContext) NUM_REAL() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserNUM_REAL, 0)
}
...
func (p *T4AlgumaParser) Parcela_unario() (localctx IParcela_unarioContext) {
	localctx = NewParcela_unarioContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 24, T4AlgumaParserRULE_parcela_unario)
	var _la int
	...
	case 1:
		...
		if _la == T4AlgumaParserPONTEIRO {
			{
				p.SetState(189)
				p.Match(T4AlgumaParserPONTEIRO)
				if p.HasError() {
					// Recognition error - abort rule
					goto errorExit
				}
	...
	case 2:
		...
		{
			p.SetState(203)
			p.Match(T4AlgumaParserFECHAPAR)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
	...
	case 4:
		...
		{
			p.SetState(206)
			p.Match(T4AlgumaParserNUM_REAL)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyOp_unarioContext() *Op_unarioContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_op_unario
	return p
}
...
func (p *T4AlgumaParser) Op_unario() (localctx IOp_unarioContext) {
	localctx = NewOp_unarioContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 26, T4AlgumaParserRULE_op_unario)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(213)
		p.Match(T4AlgumaParserSUBTRACAO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyParcela_nao_unarioContext() *Parcela_nao_unarioContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_parcela_nao_unario
	return p
}
...
func (s *Parcela_nao_unarioContext) ENDERECO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserENDERECO, 0)
}
...
func (s *Parcela_nao_unarioContext) CADEIA() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserCADEIA, 0)
}
...
func (p *T4AlgumaParser) Parcela_nao_unario() (localctx IParcela_nao_unarioContext) {
	localctx = NewParcela_nao_unarioContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 28, T4AlgumaParserRULE_parcela_nao_unario)
	p.SetState(218)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
		goto errorExit
	...
	switch p.GetTokenStream().LA(1) {
	case T4AlgumaParserENDERECO:
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(215)
			p.Match(T4AlgumaParserENDERECO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
	...
	case T4AlgumaParserCADEIA:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(217)
			p.Match(T4AlgumaParserCADEIA)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyTipoContext() *TipoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_tipo
	return p
}
...
func (p *T4AlgumaParser) Tipo() (localctx ITipoContext) {
	localctx = NewTipoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 30, T4AlgumaParserRULE_tipo)
	p.SetState(222)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
		goto errorExit
	...
	case T4AlgumaParserLITERAL, T4AlgumaParserINTEIRO, T4AlgumaParserREAL, T4AlgumaParserLOGICO, T4AlgumaParserPONTEIRO, T4AlgumaParserIDENT:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(221)
			p.Tipo_variavel()
...
func NewEmptyTipo_basicoContext() *Tipo_basicoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_tipo_basico
	return p
}
...
func (s *Tipo_basicoContext) LITERAL() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserLITERAL, 0)
}

func (s *Tipo_basicoContext) INTEIRO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserINTEIRO, 0)
}

func (s *Tipo_basicoContext) REAL() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserREAL, 0)
}

func (s *Tipo_basicoContext) LOGICO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserLOGICO, 0)
}
...
func (p *T4AlgumaParser) Tipo_basico() (localctx ITipo_basicoContext) {
	localctx = NewTipo_basicoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 32, T4AlgumaParserRULE_tipo_basico)
	var _la int
...
func NewEmptyTipo_variavelContext() *Tipo_variavelContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_tipo_variavel
	return p
}
...
func (p *T4AlgumaParser) Tipo_variavel() (localctx ITipo_variavelContext) {
	localctx = NewTipo_variavelContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 34, T4AlgumaParserRULE_tipo_variavel)
	var _la int
	...
	switch p.GetTokenStream().LA(1) {
	case T4AlgumaParserLITERAL, T4AlgumaParserINTEIRO, T4AlgumaParserREAL, T4AlgumaParserLOGICO:
		{
			p.SetState(229)
			p.Tipo_basico()
		}

	case T4AlgumaParserIDENT:
		{
			p.SetState(230)
			p.Match(T4AlgumaParserIDENT)
			if p.HasError() {
...
func NewEmptyValor_constanteContext() *Valor_constanteContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_valor_constante
	return p
}
...
func (s *Valor_constanteContext) VERDADEIRO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserVERDADEIRO, 0)
}

func (s *Valor_constanteContext) FALSO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserFALSO, 0)
}
...
func (p *T4AlgumaParser) Valor_constante() (localctx IValor_constanteContext) {
	localctx = NewValor_constanteContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 36, T4AlgumaParserRULE_valor_constante)
	var _la int
...
func NewEmptyRegistroContext() *RegistroContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_registro
	return p
}
...
func (s *RegistroContext) REGISTRO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserREGISTRO, 0)
}

func (s *RegistroContext) FIM_REGISTRO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserFIM_REGISTRO, 0)
}
...
func (p *T4AlgumaParser) Registro() (localctx IRegistroContext) {
	localctx = NewRegistroContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 38, T4AlgumaParserRULE_registro)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(235)
		p.Match(T4AlgumaParserREGISTRO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
	...
	{
		p.SetState(242)
		p.Match(T4AlgumaParserFIM_REGISTRO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyParametroContext() *ParametroContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_parametro
	return p
}
...
func (s *ParametroContext) VAR() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserVAR, 0)
}
...
func (p *T4AlgumaParser) Parametro() (localctx IParametroContext) {
	localctx = NewParametroContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 40, T4AlgumaParserRULE_parametro)
	var _la int
	...
	if _la == T4AlgumaParserVAR {
		{
			p.SetState(244)
			p.Match(T4AlgumaParserVAR)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyParametrosContext() *ParametrosContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_parametros
	return p
}
...
func (p *T4AlgumaParser) Parametros() (localctx IParametrosContext) {
	localctx = NewParametrosContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 42, T4AlgumaParserRULE_parametros)
	var _la int
...
func NewEmptyDeclaracoes_funcoesContext() *Declaracoes_funcoesContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_declaracoes_funcoes
	return p
}
...
func (s *Declaracoes_funcoesContext) PROCEDIMENTO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserPROCEDIMENTO, 0)
}
...
func (s *Declaracoes_funcoesContext) FIM_PROCEDIMENTO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserFIM_PROCEDIMENTO, 0)
}
...
func (s *Declaracoes_funcoesContext) FUNCAO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserFUNCAO, 0)
}
...
func (s *Declaracoes_funcoesContext) FIM_FUNCAO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserFIM_FUNCAO, 0)
}
...
func (p *T4AlgumaParser) Declaracoes_funcoes() (localctx IDeclaracoes_funcoesContext) {
	localctx = NewDeclaracoes_funcoesContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 44, T4AlgumaParserRULE_declaracoes_funcoes)
	var _la int
	...
	switch p.GetTokenStream().LA(1) {
	case T4AlgumaParserPROCEDIMENTO:
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(266)
			p.Match(T4AlgumaParserPROCEDIMENTO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
		...
		if _la == T4AlgumaParserVAR || _la == T4AlgumaParserIDENT {
			{
				p.SetState(269)
				p.Parametros()
			}
		...
		{
			p.SetState(285)
			p.Match(T4AlgumaParserFIM_PROCEDIMENTO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
	...
	case T4AlgumaParserFUNCAO:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(286)
			p.Match(T4AlgumaParserFUNCAO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
		...
		{
			p.SetState(307)
			p.Match(T4AlgumaParserFIM_FUNCAO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyCorpoContext() *CorpoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_corpo
	return p
}
...
func (p *T4AlgumaParser) Corpo() (localctx ICorpoContext) {
	localctx = NewCorpoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 46, T4AlgumaParserRULE_corpo)
	var _la int
...
func NewEmptyCmdContext() *CmdContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_cmd
	return p
}
...
func (p *T4AlgumaParser) Cmd() (localctx ICmdContext) {
	localctx = NewCmdContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 48, T4AlgumaParserRULE_cmd)
	p.SetState(333)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
		goto errorExit
...
func NewEmptyCmdLeiaContext() *CmdLeiaContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_cmdLeia
	return p
}
...
func (s *CmdLeiaContext) LEIA() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserLEIA, 0)
}
...
func (s *CmdLeiaContext) AllPONTEIRO() []antlr.TerminalNode {
	return s.GetTokens(T4AlgumaParserPONTEIRO)
}

func (s *CmdLeiaContext) PONTEIRO(i int) antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserPONTEIRO, i)
}
...
func (p *T4AlgumaParser) CmdLeia() (localctx ICmdLeiaContext) {
	localctx = NewCmdLeiaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 50, T4AlgumaParserRULE_cmdLeia)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(335)
		p.Match(T4AlgumaParserLEIA)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyCmdEscrevaContext() *CmdEscrevaContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_cmdEscreva
	return p
}
...
func (s *CmdEscrevaContext) ESCREVA() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserESCREVA, 0)
}
...
func (p *T4AlgumaParser) CmdEscreva() (localctx ICmdEscrevaContext) {
	localctx = NewCmdEscrevaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 52, T4AlgumaParserRULE_cmdEscreva)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(353)
		p.Match(T4AlgumaParserESCREVA)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyCmdSeContext() *CmdSeContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_cmdSe
	return p
}
...
func (s *CmdSeContext) SE() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserSE, 0)
}
...
func (s *CmdSeContext) ENTAO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserENTAO, 0)
}

func (s *CmdSeContext) FIM_SE() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserFIM_SE, 0)
}

func (s *CmdSeContext) SENAO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserSENAO, 0)
}
...
func (p *T4AlgumaParser) CmdSe() (localctx ICmdSeContext) {
	localctx = NewCmdSeContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 54, T4AlgumaParserRULE_cmdSe)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(365)
		p.Match(T4AlgumaParserSE)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
	...
	if _la == T4AlgumaParserSENAO {
		{
			p.SetState(374)
			p.Match(T4AlgumaParserSENAO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyCmdCasoContext() *CmdCasoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_cmdCaso
	return p
}
...
func (s *CmdCasoContext) CASO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserCASO, 0)
}
...
func (s *CmdCasoContext) SEJA() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserSEJA, 0)
}
...
func (s *CmdCasoContext) FIM_CASO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserFIM_CASO, 0)
}
...
func (p *T4AlgumaParser) CmdCaso() (localctx ICmdCasoContext) {
	localctx = NewCmdCasoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 56, T4AlgumaParserRULE_cmdCaso)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(385)
		p.Match(T4AlgumaParserCASO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
	...
	{
		p.SetState(398)
		p.Match(T4AlgumaParserFIM_CASO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyCmdParaContext() *CmdParaContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_cmdPara
	return p
}
...
func (s *CmdParaContext) PARA() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserPARA, 0)
}
...
func (s *CmdParaContext) ATRIBUICAO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserATRIBUICAO, 0)
}

func (s *CmdParaContext) ATE() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserATE, 0)
}

func (s *CmdParaContext) FACA() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserFACA, 0)
}

func (s *CmdParaContext) FIM_PARA() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserFIM_PARA, 0)
}
...
func (p *T4AlgumaParser) CmdPara() (localctx ICmdParaContext) {
	localctx = NewCmdParaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 58, T4AlgumaParserRULE_cmdPara)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(400)
		p.Match(T4AlgumaParserPARA)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
	...
	{
		p.SetState(402)
		p.Match(T4AlgumaParserATRIBUICAO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
	...
	{
		p.SetState(413)
		p.Match(T4AlgumaParserFIM_PARA)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyCmdEnquantoContext() *CmdEnquantoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_cmdEnquanto
	return p
}
...
func (s *CmdEnquantoContext) ENQUANTO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserENQUANTO, 0)
}
...
func (s *CmdEnquantoContext) FIM_ENQUANTO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserFIM_ENQUANTO, 0)
}
...
func (p *T4AlgumaParser) CmdEnquanto() (localctx ICmdEnquantoContext) {
	localctx = NewCmdEnquantoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 60, T4AlgumaParserRULE_cmdEnquanto)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(415)
		p.Match(T4AlgumaParserENQUANTO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
	...
	{
		p.SetState(424)
		p.Match(T4AlgumaParserFIM_ENQUANTO)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyCmdFacaContext() *CmdFacaContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_cmdFaca
	return p
}
...
func (p *T4AlgumaParser) CmdFaca() (localctx ICmdFacaContext) {
	localctx = NewCmdFacaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 62, T4AlgumaParserRULE_cmdFaca)
	var _la int
...
func NewEmptyCmdAtribuicaoContext() *CmdAtribuicaoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_cmdAtribuicao
	return p
}
...
func (p *T4AlgumaParser) CmdAtribuicao() (localctx ICmdAtribuicaoContext) {
	localctx = NewCmdAtribuicaoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 64, T4AlgumaParserRULE_cmdAtribuicao)
	var _la int
...
func NewEmptyCmdChamadaContext() *CmdChamadaContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_cmdChamada
	return p
}
...
func (p *T4AlgumaParser) CmdChamada() (localctx ICmdChamadaContext) {
	localctx = NewCmdChamadaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 66, T4AlgumaParserRULE_cmdChamada)
	var _la int
...
func NewEmptyCmdRetorneContext() *CmdRetorneContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_cmdRetorne
	return p
}
...
func (s *CmdRetorneContext) RETORNE() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserRETORNE, 0)
}
...
func (p *T4AlgumaParser) CmdRetorne() (localctx ICmdRetorneContext) {
	localctx = NewCmdRetorneContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 68, T4AlgumaParserRULE_cmdRetorne)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(455)
		p.Match(T4AlgumaParserRETORNE)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptySelecaoContext() *SelecaoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_selecao
	return p
}
...
func (p *T4AlgumaParser) Selecao() (localctx ISelecaoContext) {
	localctx = NewSelecaoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 70, T4AlgumaParserRULE_selecao)
	var _la int
	...
	for _la == T4AlgumaParserSUBTRACAO || _la == T4AlgumaParserNUM_INT {
		{
			p.SetState(458)
			p.Item_selecao()
		}
...
func NewEmptyItem_selecaoContext() *Item_selecaoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_item_selecao
	return p
}
...
func (p *T4AlgumaParser) Item_selecao() (localctx IItem_selecaoContext) {
	localctx = NewItem_selecaoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 72, T4AlgumaParserRULE_item_selecao)
	var _la int
...
func NewEmptyConstantesContext() *ConstantesContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_constantes
	return p
}
...
func (p *T4AlgumaParser) Constantes() (localctx IConstantesContext) {
	localctx = NewConstantesContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 74, T4AlgumaParserRULE_constantes)
	var _la int
...
func NewEmptyNumero_intervaloContext() *Numero_intervaloContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_numero_intervalo
	return p
}
...
func (s *Numero_intervaloContext) AllNUM_INT() []antlr.TerminalNode {
	return s.GetTokens(T4AlgumaParserNUM_INT)
}

func (s *Numero_intervaloContext) NUM_INT(i int) antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserNUM_INT, i)
}
...
func (s *Numero_intervaloContext) INTERVALO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserINTERVALO, 0)
}
...
func (p *T4AlgumaParser) Numero_intervalo() (localctx INumero_intervaloContext) {
	localctx = NewNumero_intervaloContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 76, T4AlgumaParserRULE_numero_intervalo)
	var _la int
	...
	if _la == T4AlgumaParserINTERVALO {
		{
			p.SetState(484)
			p.Match(T4AlgumaParserINTERVALO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyExp_relacionalContext() *Exp_relacionalContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_exp_relacional
	return p
}
...
func (p *T4AlgumaParser) Exp_relacional() (localctx IExp_relacionalContext) {
	localctx = NewExp_relacionalContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 78, T4AlgumaParserRULE_exp_relacional)
	var _la int
...
func NewEmptyOp_relacionalContext() *Op_relacionalContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_op_relacional
	return p
}
...
func (p *T4AlgumaParser) Op_relacional() (localctx IOp_relacionalContext) {
	localctx = NewOp_relacionalContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 80, T4AlgumaParserRULE_op_relacional)
	var _la int
...
func NewEmptyExpressaoContext() *ExpressaoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_expressao
	return p
}
...
func (p *T4AlgumaParser) Expressao() (localctx IExpressaoContext) {
	localctx = NewExpressaoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 82, T4AlgumaParserRULE_expressao)
	var _la int
...
func NewEmptyTermo_logicoContext() *Termo_logicoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_termo_logico
	return p
}
...
func (p *T4AlgumaParser) Termo_logico() (localctx ITermo_logicoContext) {
	localctx = NewTermo_logicoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 84, T4AlgumaParserRULE_termo_logico)
	var _la int
...
func NewEmptyFator_logicoContext() *Fator_logicoContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_fator_logico
	return p
}
...
func (s *Fator_logicoContext) NAO() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserNAO, 0)
}
...
func (p *T4AlgumaParser) Fator_logico() (localctx IFator_logicoContext) {
	localctx = NewFator_logicoContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 86, T4AlgumaParserRULE_fator_logico)
	var _la int
	...
	if _la == T4AlgumaParserNAO {
		{
			p.SetState(517)
			p.Match(T4AlgumaParserNAO)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyParcela_logicaContext() *Parcela_logicaContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_parcela_logica
	return p
}
...
func (p *T4AlgumaParser) Parcela_logica() (localctx IParcela_logicaContext) {
	localctx = NewParcela_logicaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 88, T4AlgumaParserRULE_parcela_logica)
	var _la int
	...
	switch p.GetTokenStream().LA(1) {
	case T4AlgumaParserVERDADEIRO, T4AlgumaParserFALSO:
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(522)
			_la = p.GetTokenStream().LA(1)

			if !(_la == T4AlgumaParserVERDADEIRO || _la == T4AlgumaParserFALSO) {
				p.GetErrorHandler().RecoverInline(p)
			} else {
				p.GetErrorHandler().ReportMatch(p)
				p.Consume()
	...
	case T4AlgumaParserABREPAR, T4AlgumaParserSUBTRACAO, T4AlgumaParserPONTEIRO, T4AlgumaParserENDERECO, T4AlgumaParserNUM_INT, T4AlgumaParserNUM_REAL, T4AlgumaParserIDENT, T4AlgumaParserCADEIA:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(523)
			p.Exp_relacional()
...
func NewEmptyOp_logico_1Context() *Op_logico_1Context {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_op_logico_1
	return p
}
...
func (s *Op_logico_1Context) OU() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserOU, 0)
}
...
func (p *T4AlgumaParser) Op_logico_1() (localctx IOp_logico_1Context) {
	localctx = NewOp_logico_1Context(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 90, T4AlgumaParserRULE_op_logico_1)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(526)
		p.Match(T4AlgumaParserOU)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyOp_logico_2Context() *Op_logico_2Context {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = T4AlgumaParserRULE_op_logico_2
	return p
}
...
func (s *Op_logico_2Context) E() antlr.TerminalNode {
	return s.GetToken(T4AlgumaParserE, 0)
}
...
func (p *T4AlgumaParser) Op_logico_2() (localctx IOp_logico_2Context) {
	localctx = NewOp_logico_2Context(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 92, T4AlgumaParserRULE_op_logico_2)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(528)
		p.Match(T4AlgumaParserE)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
