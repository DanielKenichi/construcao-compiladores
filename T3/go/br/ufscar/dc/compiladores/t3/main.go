...
import (
	...
	"github.com/DanielKenichi/construcao-compiladores/T3/go/br/ufscar/dc/compiladores/t3/errortokens"
	"github.com/DanielKenichi/construcao-compiladores/T3/go/br/ufscar/dc/compiladores/t3/visitor"
	"github.com/DanielKenichi/construcao-compiladores/T3/go/br/ufscar/dc/compiladores/t3/vocabulary"
...
func main() {
	...
	lexer := parser.NewT3AlgumaLexer(input)
	...
	parser := parser.NewT3AlgumaParser(tokens)
